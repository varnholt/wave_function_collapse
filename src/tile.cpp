...
Tile::Tile(int32_t tile_index, int32_t array_index)
    : _tileset_index(tile_index), _instance_index(instance_counter++), _array_index(array_index)
{
}

Tile::Tile(int32_t tile_index, const std::array<std::set<int32_t>, 4>& compatible_tiles)
    : _tileset_index(tile_index), _instance_index(instance_counter++), _compatible_tiles(compatible_tiles)
{
}
